...
// added m.member_phone for whatsapp circulation - fahmiyufrizal
if (isset($_SESSION['memberID'])) {
    ...
    // table header
	// Added notifikasi wa coloumn - fahmiyufrizal
    ...
    while ($loan_list_data = $loan_list_query->fetch_assoc()) {
        ...
        // row colums array
		// added array for notifikasi wa - fahmiyufrizal - v1
        $fields = array(
            $return_link,
            $extend_link,
			$wa_notif, 
        ...
        $loan_list->setCellAttr($row, 3, "valign='top' class='$row_class' style='width: 10%;'");
